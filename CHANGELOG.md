...
- Updated project version to 1.28.0.

## [1.26.0] - 2024-12-21

### Fixed
- **Version Placeholder**: Fixed {{.Version}} placeholder not being populated in project templates
- **Template Generation**: Ensured version data is properly passed to all project templates

### Improved
- **Version Management**: Centralized version constant in utils package for consistency
- **Project Generation**: Enhanced template data structure to include version information
...
[1.31.0]: https://github.com/oakhouse-ai/go-to-oakhouse/compare/v1.30.0...v1.31.0
